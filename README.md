...
- ✅ **Automate Git workflows**  
  Streamline repetitive Git tasks using automation scripts.

- ✅ **Build and deploy containerized apps**  
  Practice Docker and Docker Compose with real-world projects.

- ✅ **Understand DevOps principles with AI-driven enhancements**  
  Learn how AI can optimize CI/CD pipelines and infrastructure.
